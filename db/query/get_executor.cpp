 ...
 */
Status prepareExecution(OperationContext* opCtx,             //@@@prox : main entry point here
                        Collection* collection,
                        WorkingSet* ws,
                        CanonicalQuery* canonicalQuery,
    ...
    *querySolutionOut = NULL;
    ...
    if (descriptor && IDHackStage::supportsQuery(*canonicalQuery)) {
        ...
        *rootOut = new IDHackStage(opCtx, collection, canonicalQuery, ws, descriptor);
        ...
        return Status::OK();
    }  // @@@prox : may repeat this block for PostingListIndex queries
// @@@prox : may repeat the IDHack logic
